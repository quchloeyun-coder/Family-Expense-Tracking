...
function App(){
  ...
  if(tab==="add"){
    ...
    tabContent=h('div',{style:{display:"flex",flexDirection:"column",height:"calc(100vh - 70px)",overflow:"hidden",justifyContent:"space-between"}},TopBar,
      ...
      h('div',{style:{background:"#fff",borderRadius:14,margin:"0 14px 6px",padding:"6px 10px",boxShadow:"0 2px 8px rgba(0,0,0,.04)"}},
        ...
        h('button',{onClick:save,style:{width:"100%",padding:12,marginTop:6,border:"none",borderRadius:12,fontSize:15,fontWeight:700,background:"linear-gradient(135deg,#667eea,#764ba2)",color:"#fff",cursor:"pointer"}},"记一笔 ✓")));
  }else if(tab==="home"){
